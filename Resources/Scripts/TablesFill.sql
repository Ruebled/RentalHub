...
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 1, TO_DATE('2024-07-15', 'YYYY-MM-DD'), TO_DATE('2024-07-30', 'YYYY-MM-DD'), 1200.00, 'Active', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 2, TO_DATE('2024-08-01', 'YYYY-MM-DD'), TO_DATE('2024-08-10', 'YYYY-MM-DD'), 800.00, 'Cancelled', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 3, TO_DATE('2024-08-20', 'YYYY-MM-DD'), TO_DATE('2024-08-31', 'YYYY-MM-DD'), 1500.00, 'Active', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 4, TO_DATE('2024-09-05', 'YYYY-MM-DD'), TO_DATE('2024-09-15', 'YYYY-MM-DD'), 1000.00, 'Cancelled', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 5, TO_DATE('2024-09-20', 'YYYY-MM-DD'), TO_DATE('2024-10-05', 'YYYY-MM-DD'), 1800.00, 'Active', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 6, TO_DATE('2024-10-15', 'YYYY-MM-DD'), TO_DATE('2024-10-30', 'YYYY-MM-DD'), 1300.00, 'Cancelled', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 7, TO_DATE('2024-11-05', 'YYYY-MM-DD'), TO_DATE('2024-11-15', 'YYYY-MM-DD'), 900.00, 'Active', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 8, TO_DATE('2024-11-20', 'YYYY-MM-DD'), TO_DATE('2024-12-05', 'YYYY-MM-DD'), 1100.00, 'Cancelled', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 9, TO_DATE('2024-12-10', 'YYYY-MM-DD'), TO_DATE('2024-12-20', 'YYYY-MM-DD'), 1600.00, 'Active', SYSTIMESTAMP);
INSERT INTO Bookings (BookingID, GuestID, ApartmentID, CheckInDate, CheckOutDate, TotalPrice, Status, CreatedAt) VALUES (booking_id_seq.NEXTVAL, 2, 10, TO_DATE('2024-12-25', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 1400.00, 'Cancelled', SYSTIMESTAMP);
